...
import { Button, Card, ChipGroup, Dropdown, TextField } from "@/shared/ui";
        ...
        <Card className="border-primary">
          <div className="flex flex-col gap-3">
            ...
            <ChipGroup
              ...
              onChange={(value) => patch({ schedulingType: value })}
            />
            {form.schedulingType === "monthly" ? (
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <ChipGroup options={[{ label: "Cada N días", value: "days" }, { label: "Cada N meses", value: "months" }]} value={form.intervalUnit} onChange={(value) => patch({ intervalUnit: value })} />
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <ChipGroup options={[{ label: "Efectivo", value: "efectivo" }, { label: "Crédito", value: "credito" }]} value={form.metodoPago} onChange={(value) => patch({ metodoPago: value, creditCardId: value === "efectivo" ? "" : form.creditCardId || creditCards[0]?.id || "" })} />
  ...
  return (
    <SimpleList
      ...
      form={<>
        ...
        <ChipGroup options={[{ label: "Monto conocido", value: "yes" }, { label: "Por definir", value: "no" }]} value={form.amountKnown ? "yes" : "no"} onChange={(value) => setForm({ ...form, amountKnown: value === "yes" })} />
    ...
    <div className="flex flex-col gap-3">
      <Card>
        <div className="flex flex-col gap-3">
          ...
          <ChipGroup options={[{ label: "A meses", value: "meses" }, { label: "Pago único", value: "unico" }]} value={simType} onChange={(value) => setSimType(value as "meses" | "unico")} />
