...
export function AssistantScreen() {
  ...
  const { rawNotes, setRawNotes } = useAssistantStore();
      ...
      <div className="feature-content assistant-content">
        <Card>
          <div className="flex flex-col gap-3">
            ...
            <textarea
              className="min-h-40 rounded-md border border-gray-300 px-3 py-2 text-sm outline-none focus:border-primary focus:ring-1 focus:ring-primary"
              value={rawNotes}
        ...
        {analysis && (
          <>
            ...
            {gastos.length > 0 && (
              <Card>
                <div className="flex flex-col gap-3">
                  <h3 className="text-sm font-bold text-gray-900">💰 Gastos detectados — elige a dónde van</h3>
                  {gastos.map((g, i) => (
