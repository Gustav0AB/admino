...
export const tableStyles = StyleSheet.create({
  ...
  searchInput: { flex: 1, fontSize: TYPOGRAPHY.fontSize.sm, paddingVertical: 2 },
  ...
  panelActions: { flexDirection: "row", gap: SPACING.sm, justifyContent: "flex-end" },
  ...
  paginationControls: { flexDirection: "row", alignItems: "center", gap: SPACING.xs + 2 },
  ...
  mobileCheckboxRow: { flexDirection: "row", alignItems: "center", gap: SPACING.sm, paddingBottom: SPACING.xs },
  mobileSelectLabel: { fontSize: TYPOGRAPHY.fontSize.xs },
  mobileActionsRow: { flexDirection: "row", justifyContent: "flex-end", gap: SPACING.sm, marginTop: SPACING.sm },
});
